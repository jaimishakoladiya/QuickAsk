...
<Grid container spacing={3} style={{marginLeft:'10px'}}>
        ...
        <Grid container spacing={3} style={{marginLeft:'10px'}}>
        <Grid item xs>
        <TextField style={{width:'250px',marginTop:'5px'}} placeholder="Enter FirstName"  id="standard-basic"  variant="standard" />
        </Grid>
        <Grid item xs>
        <TextField style={{width:'250px',marginTop:'5px'}} placeholder="Enter LastName"  id="standard-basic"  variant="standard" />
        </Grid>
        <Grid item xs>
        <TextField style={{width:'250px',marginTop:'5px'}} placeholder="Enter Email"  id="standard-basic"  variant="standard" />
        </Grid>
</Grid>
