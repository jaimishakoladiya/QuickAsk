...
function About() {
    return (
     ...
     <h5 className="red-title">we are just getting started!!yahhhooo</h5>
     ...
     <h5 className="red-title"> Many of us have been there, right?</h5>
     <p className="inner-text">As the world becomes united and technology allows for constant and instant communication, 
     ...
     <img className="about-img2" src={img2}/>
      <div className="col-8">
     <h4 className="footer-title">MISSION STATMENT</h4>
